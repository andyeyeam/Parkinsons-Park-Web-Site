        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-white z-10">
          <div className="max-w-3xl">
            ...
            <p className="text-xl md:text-2xl text-emerald-50 mb-8 font-light">
              Parkinson’s Park sits on the hillside behind Netherfield Road: access is via entrances on Kelcliffe Lane, Greenshaw Terrace, Parkinson Way, Nethercliffe Crescent and Hillside Avenue.
            </p>
